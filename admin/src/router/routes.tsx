...
const routes = [
    ...
    },
    {
        ...
        element: <TermsAndConditions onSave={(content) => console.log(content)}/>
    },
    {
        path: '/components/exchange-process',
        element: <ExchangeProcess onSave={(content) => console.log(content)}/>
    },
    {
        path: '/components/cancellation-policy',
        element: <CancellationPolicy onSave={(content) => console.log(content)}/>
    },
    {
        path: '/components/refund-policy',
        element: <RefundPolicy onSave={(content) => console.log(content)}/>
    },
    {
        path: '/components/shipping-locations',
        element: <ShippingLocations onSave={(content) => console.log(content)}/>
    },
    {
        path: '/components/terms-service',
        element: <TermsOfService onSave={(content) => console.log(content)}/>
    },
    {

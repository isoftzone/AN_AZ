...
const ItemMaster: React.FC = () => {
    ...
    const SaveData = async () => {
        ...
        try {
            ...
            if (editId) {
                ...
                await axios.put(`${BASE_URL}/update/${editId}`, data, {
                    headers: {
                ...
                // Add new item
                await axios.post(`${BASE_URL}/addItem`, data, {
                    headers: {
                        'Content-Type': 'application/json', //  'multipart/form-data'
                    },
                });
    ...
    //         formData.append("image", item.image); // Ensure image is sent correctly
    //     }
    ...
    //         } else {
    //             // Add new item
    //             await axios.post(`${BASE_URL}/addItem`, formData, {
    //                 headers: {
    //                     'Content-Type': 'multipart/form-data',
    //                 },
    //             });
    ...
    // const handleUpdateItem = async (editId: number) => {
    //     if (!editId) {
    //         alert("Invalid item ID");
    //         return;
    //     }
    ...
    //     try {
    //         const response = await axios.put(`${BASE_URL}/update/${editId}`, data, {
    //             headers: {
    //                 'Content-Type': 'application/json',
    //             },
    //         });
